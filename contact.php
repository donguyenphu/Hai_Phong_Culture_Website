    ...
    <div class="containerContact">
        <div class="formWrapper">
            <div class="form-container">
                <h1 class="contactIntroductionMain">Feel free to ask me questions!</h1>
                <form id="contact-form">
                    <label for="name" class="LAdetailMain"><strong>Name</strong></label>
                    <input type="text" name="user_name" id="name" required>

                    <label for="email" class="LAdetailMain"><strong>Email</strong></label>
                    <input type="email" name="user_email" id="email" required>

                    <label for="email" class="LAdetailMain"><strong>Subject</strong></label>
        ...
        <div class="contactInformationWrapper">
            ...
            <div class="locationAndAddressWrapper">
                ...
                <div class="addressAndPhoneWrapper">
                    ...
                    <div class="LAdetailWrapper">
                        <p class="LAdetailMain">Gmail: richarddo15022008@gmail.com</p>
                    </div>
                </div>
