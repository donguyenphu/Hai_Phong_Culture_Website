...
<body>
    ...
    <div class="peopleContact">
        ...
        <div class="peopleInformationWrapper">
            ...
            <div class="allInfoTravelWrapper history" style="background-color: #393E46;">
                <div class="peopleWrapper">
                    <div id="HaiPhongPeopleDiv1">
                        <div class="peopleIntroductionWrapper">
                            <p class="peopleIntroductionMain">
                    ...
                    <div id="HaiPhongPeopleDiv2">
                        <div class="peopleIntroductionWrapper">
                            <p class="peopleIntroductionMain">
                                Foreign visitors will receive warm welcome form our people, and also eager guides to every corners of The Habour City.
                            </p>
                        </div>
